...
public class frmPaquetes extends javax.swing.JFrame {
    ...
    private void btnLeerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLeerActionPerformed
        ...
        String organizacion = txtOrganizacion.getText();
        String codigo = txtCodigo.getText();
        lblMensaje1.setText("Datos del objeto paquete");
        lblMensaje2.setText("Modalidad: " + modalidad);
        lblMensaje3.setText("Programa: " + programa);
        lblMensaje4.setText("Organización: " + organizacion);
        lblMensaje5.setText("Codigo: " + codigo);
